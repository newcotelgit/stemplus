        ...
        <nav className="flex flex-col divide-y divide-white/10">
          {NAV_LINKS.map((l) => (
            <a
              ...
              className="text-white font-semibold text-lg py-4 px-6 hover:text-[#02C39A] transition-colors"
            >
              {l.label}
            </a>
          ))}
          <div className="px-6 py-4">
            <a
              href="#admissions"
              onClick={() => setOpen(false)}
              className="w-full inline-flex items-center justify-center rounded-xl bg-[#02C39A] text-white px-6 py-3.5 text-lg font-semibold hover:bg-[#02C39A]/90 transition-colors"
            >
              Book consultation
            </a>
          </div>
    ...
    >
      ...
      <div className="relative z-10 max-w-2xl mx-auto px-5 text-center">
        <ScrollReveal>
          ...
          <p
            className="mt-4 text-white max-w-md mx-auto"
            style={{ textWrap: "pretty" }}
          >
            Consult with our elite clinical faculty to design a targeted,
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
          ...
          <div>
            ...
            <ul className="text-base space-y-2">
              ...
              <li>
                <span className="text-slate-100 font-medium">US:</span> +1
                [Click to add number]
              </li>
              <li>
                <span className="text-slate-100 font-medium">UK:</span> +44
                [Click to add number]
              </li>
              <li>
                <span className="text-slate-100 font-medium">DE:</span> +49
                [Click to add number]
              </li>
              <li>
