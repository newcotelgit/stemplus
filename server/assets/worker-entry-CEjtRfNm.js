...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("./_tanstack-start-manifest_v-BnyGQvUl.js");
...
async function loadEntries() {
  const routerEntry = await import("./router-BKHqUSMs.js").then((n2) => n2.a);
