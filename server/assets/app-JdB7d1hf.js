import { c as reactExports, p as React, q as jsxRuntimeExports } from "./worker-entry-CEjtRfNm.js";
import { r as reactDomExports, u as useNavigate, t as toast } from "./router-BKHqUSMs.js";
import { i as isCompletedToday, h as getStreak, j as frequencyLabel, H as HABIT_COLORS, F as FrequencyPicker, B as Bell, k as createHabit, u as useAuth, l as isScheduledToday, s as saveHabits, a as BottomNav, A as AddHabitSheet, g as getHabits, b as getLogs, t as todayKey, m as toggleHabit, c as saveLogs, n as updateHabit, o as getMilestoneMessage } from "./use-auth-DXYbUCVQ.js";
import { C as Check, A as ArrowRight, S as Sparkles } from "./sparkles-CaIClNDW.js";
import { X } from "./x-D2Mqqfik.js";
import { T as Trash2, L as Leaf, a as rescheduleAllReminders, s as scheduleReminder } from "./notifications-FdIQGryn.js";
import { r as reorderHabitsInCloud, m as migrateLocalToCloud, f as fetchHabitsFromCloud, a as fetchLogsFromCloud, d as deleteHabitFromCloud, t as toggleLogInCloud, s as saveHabitToCloud, u as updateHabitInCloud } from "./habits-cloud-BoASdhM-.js";
...
function OnboardingFlow({ onComplete }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "min-h-screen flex items-center justify-center px-5", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-sm w-full", children: [
    ...
    step === 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center animate-fade-up-blur", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-2xl font-semibold text-foreground tracking-tight", style: { lineHeight: "1.2" }, children: "Welcome to Continuum" }),
